...
import {
  ...
  PROFILES_REPOSITORY,
} from '../../common/repositories/profiles/profiles.repository.interface';
import { ConfigService } from '@nestjs/config';
import getAvatarPath from '../../common/utils/get-avatar-path';
import { Avatar, Profile } from '../../../../../generated/prisma/client';
import {
  AVATARS_REPOSITORY,
